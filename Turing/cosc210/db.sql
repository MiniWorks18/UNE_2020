...
--
-- Name: department; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.department OWNER TO tmcdon26;

--
-- Name: dependent; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.dependent OWNER TO tmcdon26;

--
-- Name: dept_locations; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.dept_locations OWNER TO tmcdon26;

--
-- Name: employee; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.employee OWNER TO tmcdon26;

--
-- Name: project; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.project OWNER TO tmcdon26;

--
-- Name: works_on; Type: TABLE; Schema: public; Owner: tmcdon26
--
...
ALTER TABLE public.works_on OWNER TO tmcdon26;

--
-- Data for Name: department; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--

COPY public.department (dname, dnumber, mgrssn, mgrstartdate) FROM stdin;
...
--
-- Data for Name: dependent; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--

COPY public.dependent (essn, dependent_name, sex, bdate, relationship) FROM stdin;
...
--
-- Data for Name: dept_locations; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--
...
--
-- Data for Name: employee; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--

COPY public.employee (fname, minit, lname, ssn, bdate, address, sex, salary, superssn, dno) FROM stdin;
...
--
-- Data for Name: project; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--
...
--
-- Data for Name: works_on; Type: TABLE DATA; Schema: public; Owner: tmcdon26
--

COPY public.works_on (essn, pno, hours) FROM stdin;
123456789	1	32.5
123456789	2	7.5
666884444	3	40.0
453453453	1	20.0
...
--
-- Name: department department_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: dependent dependent_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: dept_locations dept_locations_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: employee employee_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: project project_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: project project_pname_key; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: works_on works_on_pkey; Type: CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: dependent dependent_essn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: dept_locations dept_locations_dnumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: employee employee_dno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: employee employee_superssn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--

ALTER TABLE ONLY public.employee
    ADD CONSTRAINT employee_superssn_fkey FOREIGN KEY (superssn) REFERENCES public.employee(ssn) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: project project_dnum_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: works_on works_on_essn_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
...
--
-- Name: works_on works_on_pno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tmcdon26
--
